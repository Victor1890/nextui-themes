...
export function HomeColors() {
  return (
    <section className="flex flex-col items-center justify-center py-16 space-y-8">
      <Typography
        as="h1"
        className="hidden md:block text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]"
      >
        Add colors. Make it yours.
      </Typography>
      <Typography
        as="h1"
        className="md:hidden text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]"
      >
        Make it yours.
      </Typography>
      <Typography
        as="h2"
        className="text-center md:text-balance max-w-2xl text-lg font-light text-foreground"
      >
